...
YT_HELP_MESSAGE = ["""Send links/files along with cmd or reply to cmd to mirror or leech ytdl supported stes on Telegram or GDrive or DDLs with different Engines like RClone or yt-dlp
...
MIRROR_HELP_MESSAGE = ["""Send links/files along with cmd or reply to cmd to mirror or leech on Telegram or GDrive or DDLs with different Engines like RClone, Aria2 or qBit
...
CLONE_HELP_MESSAGE = ["""Send Gdrive | Gdtot | Filepress | Filebee | Appdrive | Gdflix link or RClone path along with or by replying to the link/rc_path by command with args.
...
help_string = [f'''<b>Basic Commands!</b>
